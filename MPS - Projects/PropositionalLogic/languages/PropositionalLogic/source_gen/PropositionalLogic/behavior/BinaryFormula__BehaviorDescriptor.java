...
public final class BinaryFormula__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(addAtomicFormulaeNames_idJ56wWMX7vv, evaluatable_id3N5NPiroyCD, getBinarySymbol_id7P0OLlYl3ad, toString_id3aaZQdR$$TK, addToSubformulaList_id1OkDAl31ASe);
  ...
  /*package*/ static void addToSubformulaList_id1OkDAl31ASe(@NotNull SNode __thisNode__, List<SNode> list) {
    Formula__BehaviorDescriptor.addToSubformulaList_id1OkDAl31ASe.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.first$ZhL9), list);
    Formula__BehaviorDescriptor.addToSubformulaList_id1OkDAl31ASe.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.second$Zifb), list);
