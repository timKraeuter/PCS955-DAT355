...
public final class TwoSidedImplication__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xc8418222bda489cL, 0x8be629cedccd87d2L, 0x3cc5cf549b561c19L, "PropositionalLogic.structure.TwoSidedImplication");
  ...
  /*package*/ static boolean evaluate_id3Cmss9bwMFB(@NotNull SNode __thisNode__, Map<String, Boolean> valuation) {
    //  A -> B = !A || B Law 5.2.1.(7)  
    boolean forward = !((boolean) Formula__BehaviorDescriptor.evaluate_id3Cmss9bwMFB.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.first$ZhL9), valuation)) || (boolean) Formula__BehaviorDescriptor.evaluate_id3Cmss9bwMFB.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.second$Zifb), valuation);
    //  B -> A = !B || A 
    boolean backward = !((boolean) Formula__BehaviorDescriptor.evaluate_id3Cmss9bwMFB.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.second$Zifb), valuation)) || (boolean) Formula__BehaviorDescriptor.evaluate_id3Cmss9bwMFB.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.first$ZhL9), valuation);
    //  TODO: reuse implication implementation across behaviors. 
  ...
  /*package*/ TwoSidedImplication__BehaviorDescriptor() {
  }
