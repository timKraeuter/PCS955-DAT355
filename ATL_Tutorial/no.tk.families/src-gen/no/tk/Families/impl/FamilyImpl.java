 ...
 * </p>
 * <ul>
 *   <li>{@link no.tk.Families.impl.FamilyImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link no.tk.Families.impl.FamilyImpl#getFather <em>Father</em>}</li>
 *   <li>{@link no.tk.Families.impl.FamilyImpl#getMother <em>Mother</em>}</li>
 *   <li>{@link no.tk.Families.impl.FamilyImpl#getSons <em>Sons</em>}</li>
 *   <li>{@link no.tk.Families.impl.FamilyImpl#getDaughters <em>Daughters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FamilyImpl extends MinimalEObjectImpl.Container implements Family {
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.FAMILY__LAST_NAME, oldLastName,
					lastName));
	}
	...
	public void setFather(Member newFather) {
		if (newFather != father) {
			...
			if (father != null)
				msgs = ((InternalEObject) father).eInverseRemove(this, FamiliesPackage.MEMBER__FAMILY_FATHER,
						Member.class, msgs);
			if (newFather != null)
				msgs = ((InternalEObject) newFather).eInverseAdd(this, FamiliesPackage.MEMBER__FAMILY_FATHER,
						Member.class, msgs);
	...
	public void setMother(Member newMother) {
		if (newMother != mother) {
			NotificationChain msgs = null;
			if (mother != null)
				msgs = ((InternalEObject) mother).eInverseRemove(this, FamiliesPackage.MEMBER__FAMILY_MOTHER,
						Member.class, msgs);
			if (newMother != null)
				msgs = ((InternalEObject) newMother).eInverseAdd(this, FamiliesPackage.MEMBER__FAMILY_MOTHER,
						Member.class, msgs);
	...
	public EList<Member> getSons() {
		if (sons == null) {
			sons = new EObjectContainmentWithInverseEList<Member>(Member.class, this, FamiliesPackage.FAMILY__SONS,
					FamiliesPackage.MEMBER__FAMILY_SON);
		}
		return sons;
	}
	...
	public EList<Member> getDaughters() {
		if (daughters == null) {
			daughters = new EObjectContainmentWithInverseEList<Member>(Member.class, this,
					FamiliesPackage.FAMILY__DAUGHTERS, FamiliesPackage.MEMBER__FAMILY_DAUGHTER);
		}
		return daughters;
	}
