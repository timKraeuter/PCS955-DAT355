/**
 */
package no.tk.Families.impl;

import no.tk.Families.FamiliesPackage;
import no.tk.Families.Family;
import no.tk.Families.Member;
 ...
 * </p>
 * <ul>
 *   <li>{@link no.tk.Families.impl.MemberImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link no.tk.Families.impl.MemberImpl#getFamilyFather <em>Family Father</em>}</li>
 *   <li>{@link no.tk.Families.impl.MemberImpl#getFamilyMother <em>Family Mother</em>}</li>
 *   <li>{@link no.tk.Families.impl.MemberImpl#getFamilySon <em>Family Son</em>}</li>
 *   <li>{@link no.tk.Families.impl.MemberImpl#getFamilyDaughter <em>Family Daughter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberImpl extends MinimalEObjectImpl.Container implements Member {
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.MEMBER__FIRST_NAME, oldFirstName,
					firstName));
	}
	...
	public Family getFamilyFather() {
		if (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_FATHER)
			return null;
	...
	public void setFamilyFather(Family newFamilyFather) {
		if (newFamilyFather != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_FATHER && newFamilyFather != null)) {
			...
			if (newFamilyFather != null)
				msgs = ((InternalEObject) newFamilyFather).eInverseAdd(this, FamiliesPackage.FAMILY__FATHER,
						Family.class, msgs);
			msgs = basicSetFamilyFather(newFamilyFather, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.MEMBER__FAMILY_FATHER,
					newFamilyFather, newFamilyFather));
	}
	...
	public Family getFamilyMother() {
		if (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_MOTHER)
			return null;
		return (Family) eInternalContainer();
	}
	...
	public void setFamilyMother(Family newFamilyMother) {
		if (newFamilyMother != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_MOTHER && newFamilyMother != null)) {
			...
			if (newFamilyMother != null)
				msgs = ((InternalEObject) newFamilyMother).eInverseAdd(this, FamiliesPackage.FAMILY__MOTHER,
						Family.class, msgs);
			msgs = basicSetFamilyMother(newFamilyMother, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.MEMBER__FAMILY_MOTHER,
					newFamilyMother, newFamilyMother));
	}
	...
	public Family getFamilySon() {
		if (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_SON)
			return null;
		return (Family) eInternalContainer();
	}
	...
	public void setFamilySon(Family newFamilySon) {
		if (newFamilySon != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_SON && newFamilySon != null)) {
			...
			if (newFamilySon != null)
				msgs = ((InternalEObject) newFamilySon).eInverseAdd(this, FamiliesPackage.FAMILY__SONS, Family.class,
						msgs);
			msgs = basicSetFamilySon(newFamilySon, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.MEMBER__FAMILY_SON, newFamilySon,
					newFamilySon));
	}
	...
	public Family getFamilyDaughter() {
		if (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_DAUGHTER)
			return null;
		return (Family) eInternalContainer();
	}
	...
	public void setFamilyDaughter(Family newFamilyDaughter) {
		if (newFamilyDaughter != eInternalContainer()
				|| (eContainerFeatureID() != FamiliesPackage.MEMBER__FAMILY_DAUGHTER && newFamilyDaughter != null)) {
			...
			if (newFamilyDaughter != null)
				msgs = ((InternalEObject) newFamilyDaughter).eInverseAdd(this, FamiliesPackage.FAMILY__DAUGHTERS,
						Family.class, msgs);
			msgs = basicSetFamilyDaughter(newFamilyDaughter, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FamiliesPackage.MEMBER__FAMILY_DAUGHTER,
					newFamilyDaughter, newFamilyDaughter));
	}
