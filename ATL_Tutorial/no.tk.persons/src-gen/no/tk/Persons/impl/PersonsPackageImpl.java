...
import no.tk.Persons.Female;
import no.tk.Persons.Male;
import no.tk.Persons.Person;
import no.tk.Persons.PersonsFactory;
...
public class PersonsPackageImpl extends EPackageImpl implements PersonsPackage {
	 ...
	 * @see no.tk.Persons.PersonsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_FullName(), ecorePackage.getEString(), "fullName", null, 1, 1, Person.class,
